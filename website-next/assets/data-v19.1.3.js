(function (global) {
  ...
  async function loadResearch(force) {
    ...
    researchPromise = Promise.all([
      sb.from("financial_latest").select("symbol,website_group,financial_model,period,profit_yoy_pct,income_yoy_pct,profit_qoq_pct,roea_pct,roaa_pct,debt_equity_pct,debt_assets_pct,pe,pb,freshness_status,data_status,production_ready,updated_at").order("symbol", { ascending: true }).limit(2000),
