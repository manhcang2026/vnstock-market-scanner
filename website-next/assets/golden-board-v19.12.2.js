  ...
  function guestRightRailHtml(data, teaserCount) {
    ...
    return '<aside class="gb-right-rail" aria-label="Thông tin Bảng vàng">' +
      ...
      '<section class="gb-rail-card">' +
        ...
        '<p>Bạn đang xem tối đa <b>2 mã thật</b> sau ' + fmt(delay, 0) + ' phút. Chi tiết kỹ thuật đầy đủ vẫn theo quyền thành viên.</p>' +
      ...
      return '<div class="page-shell golden-board-page">' +
        ...
        '<div class="gb-content-grid">' +
          '<div class="gb-content-main">' +
            '<section class="gb-hero-grid gb-hero-grid-guest"><div class="gb-stat"><span>Đã ghi danh</span><strong>' + fmt(marketTotal, 0) + '</strong><small>mã trong phiên</small></div><div class="gb-stat"><span>Bản xem thử</span><strong>2 mã</strong><small>hé lộ sau ' + fmt(data.teaser_delay_minutes || 20, 0) + " phút</small></div></section>" +
